...
cout <<"convert how many centimetresto kilometres and metres?"<<endl;
//command the program to get the variable centimetres cin >>centimetres
//define a variable as kilometres and convert centimetres into it.
float kilometres=centimetres/100000;
//print out the result
cout<<" this corresponds to "<<kilometers<<" km "<<endl;
//define a variable as metres and express centimetres as metres
float metres=centimetres/100;
//print out the result
cout <<" this corresponds tto "<<metres<<" mts"<<endl;
